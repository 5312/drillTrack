...
interface ChartGeo3DProps {
  isLoading: boolean
  magneticDeclination: string
}

export function ChartGeo3D({ isLoading, magneticDeclination }: ChartGeo3DProps) {
  ...
  }, [drillingData, isLoading, magneticDeclination])
  ...
  return (
    <div className="relative h-[63vh] w-full">
